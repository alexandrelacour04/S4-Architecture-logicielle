...
unvalid_data_1 = {
    ...
    "freq_min": 98,
    "data": [
        {"time": "13:00:00", "cardio_frequency": -1, "latitude": 47.644795, "longitude": -2.776605, "altitude": 18},
        {"time": "13:00:25", "cardio_frequency": 400, "latitude": 47.648510, "longitude": -2.780145, "altitude": 16}
    ]
}
...
unvalid_data_2 = {
    ...
    "freq_min": 98,
    "data": [
        {"time": "13:00:00", "cardio_frequency": 180, "latitude": 147.644795, "longitude": -2.776605, "altitude": 18},
        {"time": "13:00:25", "cardio_frequency": 103, "latitude": 47.648510, "longitude": -222.780145, "altitude": 16}
    ]
}
...
requests=[test_0, test_1, test_2, test_3, test_4, test_5, test_6, test_7,
...
if __name__ == "__main__":
    ...
    for req in requests:
        ...
        status_code, resp_body = http_request(req["method"],req["url"],req["request_payload"]);
        if status_code == req["response_code"]:
            ...
            print(f"{bcolors.OKBLUE}Request: {req['method']} {req['url']} -> Response code:{status_code}, body valid: {body_check} {bcolors.ENDC}")
        else:
            print(f"{bcolors.FAIL}Request: {req['method']} {req['url']} -> Expected status code: {req['response_code']}, returned status code: {status_code} {bcolors.ENDC}")
